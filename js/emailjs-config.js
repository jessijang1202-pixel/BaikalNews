// Baikal News - EmailJS config (sends the 제보·문의 form straight to an inbox, no backend needed)
// The public key is safe to expose client-side by design - EmailJS gates actual
