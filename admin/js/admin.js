...
[부제]
(헤드라인을 보완하는 한 줄. 12~20자 내외. 마땅한 내용이 없으면 이 항목 자체를 생략)

[핵심 포인트]
- (짧은 구 또는 절. 8~18자 내외)
- (짧은 구 또는 절)
- (짧은 구 또는 절)
(기사에서 실제로 중요한 사실만 3~5개)
...
- [핵심 포인트]의 각 항목은 완결된 문장이 아니어도 됩니다. 명사형이나 짧은 절로 끝내도 됩니다.
- 마크다운 문법(#, ** 등)이나 추가 설명 없이, 위 형식 그대로만 출력하십시오.`;

    const systemInstruction = "당신은 뉴스 기사를 한 장짜리 카드뉴스(인포그래픽) 문구로 재구성하는 카피라이터입니다. 뉴스 보도체 문장이 아니라, 헤드라인/포인트 위주의 짧고 임팩트 있는 카드뉴스 카피 문체로 쓰십시오.";
